...
// --- 🧠 STATE MANAGEMENT ---
interface UserState {
  step: 'IDLE' | 'DEPOSIT_AMOUNT' | 'DEPOSIT_CONFIRM' | 'WITHDRAW_AMOUNT' | 'WITHDRAW_PHONE' | 'TRANSFER_USERNAME' | 'TRANSFER_AMOUNT';
  data: any;
}
...
// --- HELPER FUNCTIONS ---
function verifyPaymentSMS(text: string, expectedAmount: number) { /* (Keep your existing verify function) */ return {valid:false}; }
async function getOrCreateUser(ctx: Context) { /* (Keep existing) */ }